...
const Auth = () => {
  ...
  const validateSignup = () => {
    ...
    if (password != confirmPassword) {
      toast.error("Password and Confirm Pasword should be match.");
      return false;
    }
    return true;
  };
      ...
      <div className="h-auto p-2 py-5 pb-8 bg-white border-2 border-white text-opacity-90 shadow-2xl w-[80vw] md:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2">
        <div className="flex flex-col gap-6 items-center justify-center">
          <div className="flex items-center justify-center flex-col">
            ...
            <p className="font-medium text-center">Fill in the details
              to get started with the best chat app</p>
          </div>
